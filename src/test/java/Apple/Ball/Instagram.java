...
driver.findElement(By.xpath("//*[@aria-label=\"Phone number, username, or email\"]")).sendKeys("abc@gmail.com");
driver.findElement(By.xpath("//*[@aria-label=\"Password\"]")).sendKeys("abc");
